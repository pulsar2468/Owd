...
char req_index = 0; 
const char* ssid = "FASTWEB-1-B856A7";
const char* password = "alienoadryyyy";
char x[20]="DATA/";
int g;
File webFile;
...
//if (t < 15 ) pixels.setPixelColor(0, pixels.Color(0, 0,255));
//if (t > 15) pixels.setPixelColor(0, pixels.Color(255,0, 0));
//pixels.show();
